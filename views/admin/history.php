								...
								<?php foreach ($orderList as $orderItem): ?>
									<li style=" margin: 30px;">
										...
										<ul>
											...
											?>
											<div align="center" style="margin: 30px;">Общая стоимость заказа: <?php echo $totalPrice; ?> руб.</div>
											<a class="btn" href="historyItem/<?php echo $orderItem['order_id']; ?>">Скачать накладную</a>
